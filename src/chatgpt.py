...
async def welcome(message: types.Message):
    ...
    """
    clear_past()
    await message.reply(f"Hello! \n I'm ChatGPT telegram bot created by Sushanth \n How can i help you?")
...
async def clear(message: types.Message):
    ...
    """
    clear_past()
    await message.reply(f'I have cleared the past conversation and context.')
...
async def helper(message: types.Message):
    ...
    """
    help_command ='''
    Hi there, i'm chatGPT bot created by Sushanth! please follow these commands -
